...
基于 91 个 Kubernetes 相关问题的评估结果（2025-01-09 ~ 2025-01-22 期间抓取）：

### Coverage 对比

| 模型             | 平均覆盖率 | 100%       | 90-99%   | 60-89%   | <60%       |
| ---------------- | ---------- | ---------- | -------- | -------- | ---------- |
| **gpt-4.1-mini** | 26.96%     | 13 (14.3%) | 3 (3.3%) | 7 (7.7%) | 68 (74.7%) |
| **gpt-4.1**      | 27.75%     | 16 (17.6%) | 2 (2.2%) | 5 (5.5%) | 68 (74.7%) |
| **gpt-5.1**      | 27.86%     | 14 (15.4%) | 3 (3.3%) | 7 (7.7%) | 67 (73.6%) |

### Token 消耗估算

| 阶段     | Prompt Tokens | Completion Tokens | 总计/问题  |
| -------- | ------------- | ----------------- | ---------- |
| Answer   | ~818          | ~1,276            | ~2,094     |
| Evaluate | ~3,219        | ~483              | ~3,702     |
| **合计** | -             | -                 | **~5,796** |

**91 个问题完整流程：**
- 总 Token：~527,000
- 预计成本（GPT-4.1 定价）：~$3.78

### 说明

- **Coverage** 衡量 LLM 回答中的 YAML 配置与人类回答中 YAML 配置的重叠程度
- 由于问题类型多样（部分无需 YAML 配置），大部分问题的 Coverage 较低
- 三个模型在 Coverage 指标上表现相近，gpt-5.1 略优
